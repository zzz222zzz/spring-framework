...
public class RestTemplate extends InterceptingHttpAccessor implements RestOperations {
	...
	private static final RestTemplateObservationConvention DEFAULT_OBSERVATION_CONVENTION = new DefaultRestTemplateObservationConvention();
	...
	@Nullable
	private RestTemplateObservationConvention observationConvention;
	 ...
	 * extracted from the {@link RestTemplateObservationContext}.
	 * If none set, the {@link DefaultRestTemplateObservationConvention default convention} will be used.
	 * @param observationConvention the observation convention to use
	 * @since 6.0
	 * @see #setObservationRegistry(ObservationRegistry)
	 */
	public void setObservationConvention(RestTemplateObservationConvention observationConvention) {
	...
	protected <T> T doExecute(URI url, @Nullable String uriTemplate, @Nullable HttpMethod method, @Nullable RequestCallback requestCallback,
		...
		RestTemplateObservationContext observationContext = new RestTemplateObservationContext();
		Observation observation = RestTemplateObservation.HTTP_REQUEST.observation(this.observationConvention,
