 ...
 * @since 6.0
 */
public class WebClientObservationContext extends RequestReplySenderContext<ClientRequest, ClientResponse> {

	@Nullable
	private String uriTemplate;


	public WebClientObservationContext() {
		super(WebClientObservationContext::setRequestHeader);
	}
