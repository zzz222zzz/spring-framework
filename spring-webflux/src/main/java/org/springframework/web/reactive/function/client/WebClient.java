...
public interface WebClient {
	...
	interface Builder {
		 ...
		 * metadata for the current observation. Will use {@link DefaultWebClientObservationConvention}
		 * if none provided.
		 * @param observationConvention the observation convention to use
		 * @since 6.0
		 */
		Builder observationConvention(WebClientObservationConvention observationConvention);
